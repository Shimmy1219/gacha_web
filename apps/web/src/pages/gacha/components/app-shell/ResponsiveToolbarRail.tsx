      ...
      {rendered ? (
        <>
          ...
          <aside
            ...
            className={clsx(
              'responsive-toolbar-rail__panel fixed inset-y-0 right-0 z-50 w-[70vw] max-w-md overflow-y-auto border-l px-6 pb-0 pt-16 shadow-2xl transition-transform duration-300 ease-in-out transform-gpu',
