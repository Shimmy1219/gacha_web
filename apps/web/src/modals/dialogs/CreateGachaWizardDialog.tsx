      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-border/60 bg-[#15151b] px-4 py-3 text-sm text-surface-foreground transition focus:border-accent focus:outline-none"
