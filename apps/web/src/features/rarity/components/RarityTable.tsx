  ...
  return (
    <div className="rarity-section__table-wrapper rounded-2xl border border-border/60 bg-panel shadow-sm">
      <table className="rarity-section__table w-full border-separate border-spacing-0 divide-y divide-border/60 text-left">
        ...
        <tbody className="rarity-section__table-body divide-y divide-border/40 bg-panel">
          {rows.map((row) => {
              ...
              <tr key={row.id} className="rarity-section__row text-sm text-surface-foreground">
                <td className="rarity-section__cell rarity-section__cell-label px-1 py-2">
                  <input
                    ...
                    className={clsx(
                      'rarity-section__label-input w-full rounded-xl border border-border/60 bg-panel-muted px-3 py-2 text-sm transition focus:border-accent focus:outline-none',
                ...
                <td className="rarity-section__cell rarity-section__cell-rate px-1 py-2">
                  <div className="rarity-section__rate-control flex flex-nowrap items-center gap-1.5">
                    <input
                      ...
                      className="rarity-section__rate-input w-full rounded-xl border border-border/60 bg-panel-muted px-3 py-2 text-sm text-surface-foreground focus:border-accent focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <td className="rarity-section__cell rarity-section__cell-actions px-1 py-2 text-right">
                  <button
                    type="button"
                    className="rarity-section__delete-button inline-flex items-center gap-2 whitespace-nowrap rounded-xl border border-border/70 bg-panel-muted px-3 py-1.5 text-xs text-muted-foreground transition hover:border-accent/60 hover:bg-panel hover:text-surface-foreground disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <tr className="rarity-section__add-row">
            <td className="rarity-section__cell px-1 py-3" colSpan={4}>
              <button
                type="button"
                className="rarity-section__add-button inline-flex w-full items-center justify-center rounded-xl border border-border/70 bg-panel-muted px-3 py-2 text-sm text-muted-foreground transition hover:border-accent/60 hover:bg-panel hover:text-surface-foreground disabled:cursor-not-allowed disabled:opacity-60"
                onClick={onAdd}
                disabled={!onAdd}
              >
                追加
