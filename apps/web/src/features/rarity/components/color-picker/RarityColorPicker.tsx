    ...
    isOpen && portalContainer
      ? createPortal(
          <div
            ...
            role="dialog"
            aria-modal="false"
            className="rarity-color-picker__popover fixed z-[4000] max-w-[240px] rounded-xl border border-border/70 bg-overlay p-3 text-sm text-surface-foreground shadow-[0_12px_40px_rgba(10,10,16,0.65)]"
