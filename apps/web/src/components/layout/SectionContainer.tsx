...
export function SectionContainer({
  ...
  return (
    <section
      id={id}
      className={clsx(
        'group relative flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-border/70 bg-[#0b0b13]/90 p-6 text-sm shadow-panel ring-1 ring-inset ring-white/5',
