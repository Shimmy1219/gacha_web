...
export function SectionContainer({
  ...
  return (
    <section
      id={id}
      className={clsx(
        'section-container group relative flex h-full min-h-0 flex-col overflow-hidden rounded-[1.5rem] border border-border/70 bg-[#15151b]/95 p-4 text-sm ring-1 ring-inset ring-white/5',
