...
export function OfficialXAccountPanel({
  ...
  return (
    <section
      className={clsx(
        'official-x-account-panel w-full min-w-0 max-w-full overflow-hidden rounded-2xl border border-border/60 bg-panel/70 p-4 text-left',
        isCompact ? 'official-x-account-panel--compact p-3' : 'official-x-account-panel--default',
        className
      )}
      aria-label="公式Xアカウントへの案内"
    >
      <div className="official-x-account-panel__header flex min-w-0 items-center gap-3">
        <span
          className={clsx(
        ...
        <div className="official-x-account-panel__header-text min-w-0 flex-1">
          <p
            className={clsx(
              'official-x-account-panel__account-label break-words text-xs font-semibold text-muted-foreground',
          ...
          <p
            className={clsx(
              'official-x-account-panel__account-name mt-0.5 break-words text-sm font-semibold text-surface-foreground',
          ...
          <p
            className={clsx(
              'official-x-account-panel__account-id mt-0.5 break-words text-xs font-semibold text-muted-foreground',
              isCompact ? 'text-[11px]' : undefined
            )}
          >
      ...
      <p
        className={clsx(
          'official-x-account-panel__message mt-2 break-words text-xs leading-relaxed text-muted-foreground',
          isCompact ? 'text-[11px]' : undefined
        )}
      >
      ...
      <a
        ...
        className={clsx(
          'official-x-account-panel__action-button mt-3 inline-flex w-full min-w-0 flex-wrap items-center justify-center gap-2 rounded-xl border border-black bg-black px-3 py-2 text-sm font-semibold text-white transition hover:bg-black/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/50',
          isCompact ? 'text-xs' : undefined
        )}
      >
        <XLogoIcon aria-hidden className="official-x-account-panel__action-icon h-4 w-4 rounded-[4px]" />
        <span className="official-x-account-panel__action-label min-w-0 break-words text-center">
          公式Xアカウントへ移動する
        </span>
      </a>
    </section>
