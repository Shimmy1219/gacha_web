...
export function HeaderBrand({ title, tagline }: HeaderBrandProps): JSX.Element {
  return (
    <div className="header-brand flex items-center gap-3">
      <span className="header-brand__logo relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl bg-accent text-base font-bold text-accent-foreground shadow-[0_16px_40px_rgba(255,47,93,0.45)]">
        <span
