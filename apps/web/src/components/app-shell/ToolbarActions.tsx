...
export function ToolbarActions({
  ...
  return (
    <div className={clsx('toolbar-actions', containerClass)}>
      ...
      <div className={clsx('toolbar-actions__import relative flex w-full lg:w-auto')}>
        <input
          id={inputId}
          ref={fileInputRef}
          type="file"
        ...
        <button
          ...
          className={clsx(
            'toolbar-actions__import-button inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-xl border border-border/70 bg-transparent px-4 py-2 text-sm font-semibold text-muted-foreground transition hover:border-accent/60 hover:text-surface-foreground lg:w-auto',
